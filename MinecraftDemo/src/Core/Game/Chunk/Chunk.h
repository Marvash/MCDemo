...
public:
	...
	Chunk(GameServiceLocator* gameServiceLocator, int chunkHeight, int chunkSideSize, glm::vec3 chunkPosition);
	Chunk(GameServiceLocator* gameServiceLocator, Cube*** blockMatrix, int chunkHeight, int chunkSideSize, glm::vec3 chunkPosition);
	~Chunk();
	void buildMesh();
	void loadMesh();
